...
<body>  
    <?php if(!empty($final)) { ?>
        ...
        <div class="wapper ml-10">
            ...
            <p><b>Name:</b> <?php echo $final[0]->filename; ?></p>
            <p><b>Price:</b> <?php echo $final[0]->price?>  USD </p> 
            <p><b>Date-Time:</b> <?php echo $final[0]->created_at; ?></p>
            <a class="btn btn-primary" href="<?php echo base_url();?>document/">BACK TO PAGE</a>
